...
@Composable
fun ViewHospitalScreen(navController: NavController) {
        ...
        Scaffold(
            bottomBar = {
                NavigationBar (
                    ...
                    com.example.antoproject.ui.theme.screens.products.bottomNavItems.forEachIndexed { index, bottomNavItem ->
                        NavigationBarItem(
...
@Composable
fun HospitalItem(name:String, id:String,
                navController: NavController,
                    ...
                    Column (modifier = Modifier
                        ...
                        Row (
                            ...
                            Row (
                                ...
                                IconButton(onClick = { hospitalRepository.updateHospital(id) }) {
                                    Icon(imageVector = Icons.Default.Edit, contentDescription = "", tint = Color.White)
                                }

                                Spacer(modifier = Modifier.width(5.dp))

                                IconButton(onClick = { hospitalRepository.deleteHospital(id) }) {
...
fun ViewHospitalScreenPreview(){

    ViewHospitalScreen(navController = rememberNavController())
